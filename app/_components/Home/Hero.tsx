...
const Hero = () => {
  ...
  return (
    <div className="flex items-center justify-center flex-col gap-2">
      <h2 className="text-5xl text-center font-bold fancy-text">
        Take A Test <br />{" "}
        <span className="text-primary text-5xl">Earn A Free</span> Certificate
      </h2>
      <p className="font-semibold text-zinc-500 text-center">
        You can now apply to your dream career confidently
      </p>
