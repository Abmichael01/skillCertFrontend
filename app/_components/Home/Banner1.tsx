...
const Banner1 = () => {
  return (
    <div className="bg-neutral-950 min-h-56  mt-20 p-12 md:p-20 flex flex-col-reverse gap-6 sm:flex-row justify-between items-center">
      <div className="flex flex-col gap-14 bg-gradient-to-r from-neutral-50 to-blue-500 bg-clip-text text-transparent">
        <h1 className="sm:text-7xl text-3xl max-w-[60%] font-bold font-cinzel">
          Certification Made <span className="">Easy...</span>
        </h1>
        <h1 className="sm:text-4xl text-xl font-semibold font-cinzel">
